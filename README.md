...
- Add an additional MavCmd namely: `CUSTOM_EVO_FLAP_CHECK`, to support flap checks on Evo's which have a version lower than 3.0.0
- Add an additional MavMode namely: `CUSTOM_DRAGON_LMT`, to support LMT mode on Dragon's
